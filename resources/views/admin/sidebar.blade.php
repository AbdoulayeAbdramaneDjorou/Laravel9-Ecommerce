      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
             <a href="/admin/category" class="nav-link"><i class="nav-icon fas fa-home text-yellow"></i>Dashboard</a>
          </li>
          ...
          <li class="nav-item">
            <a href="/admin/message" class="nav-link"><i class="nav-icon fas fa-mail-bulk"></i>Messages</a>
          </li>
          <li class="nav-item">
